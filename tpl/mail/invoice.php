...
<h1>Factuur <?php echo $invoicenr; ?></h1>
<p>Geachte <?php echo $title; ?>,</p>
<p>Bijgevoegd vindt u factuur <strong><?php echo $invoicenr; ?></strong></p>
<table>
  <tr>
...
<?php $hash = substr(md5(strtoupper($invoicenr).'DEKAAG123456789123456789'),8,16); ?>
...
<p><br>Deze factuur is automatisch verzonden op <?php echo date('d-m-Y'); ?>.</p>